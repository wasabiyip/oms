	    ...
	    switch (income.type){
			...
			case 'stream':
				if(handler.symbolExists(income.symbol)){
					...
					msj = {"values":{"symbol": income.symbol,"tipo": income.entry, "precio": income.precio}};
