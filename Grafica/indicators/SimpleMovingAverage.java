 ...
 * number of values to calculate it on.
 *
 */
public class SimpleMovingAverage {
    ...
    /**
     * Gets the offset attribute used to get an old SMA given a list of
    ...
    /**
     * Method that calculates the SMA based on the values and the ('n') number
     * of values
     */
    ...
    /**
     * Gets the offset attribute used to get an old simple moving average given
     * a list of chronological values.
     *
     * @return the offset
	 *
     */
    ...
    /**
     * Sets the offset used to calculate an old simple moving average given a
