...
public class StandardDeviation {
    ...
    private int N;
    /**
     * mean field is the mean for the given set of N values considered to
     * calculate the standard deviation
     */
    private double mean;
    /**
     * Offset value used to calculate a standard deviation different than the
     * one calculate with the last set of N values.
	 *
     */
     ...
     *
     * @param mean the values of the mean to be set in the mean attribute to
     * this object.
     */
    ...
    /**
     * Gets the offset attribute used to get an old standard deviation given a
     * list of chronological values.
     *
     * @return the offset
	 *
     */
    ...
    /**
     * Sets the offset used to calculate an old standard deviation given a list
     * of chronological values.
     *
